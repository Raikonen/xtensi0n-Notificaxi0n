...
ExtensionFunction::ResponseAction WindowsGetFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsGetFunction", extension()->name());
...
ExtensionFunction::ResponseAction WindowsGetCurrentFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsGetCurrentFunction",
                                            extension()->name());
...
ExtensionFunction::ResponseAction WindowsGetLastFocusedFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsGetLastFocusedFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction WindowsGetAllFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsGetAllFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction WindowsCreateFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsCreateFunction", extension()->name());
...
ExtensionFunction::ResponseAction WindowsUpdateFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("WindowsUpdateFunction", extension()->name());
...
ExtensionFunction::ResponseAction WindowsRemoveFunction::Run() {
  ...
  Xtensi0nLogger::logPermission(
      "WindowsRemoveFunction", extension()->name(),
...
ExtensionFunction::ResponseAction TabsGetSelectedFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetSelectedFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsGetAllInWindowFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetAllInWindowFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsQueryFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsQueryFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction TabsCreateFunction::Run() {
  ...
  Xtensi0nLogger::logPermission(
      "TabsCreateFunction", extension()->name(),
...
ExtensionFunction::ResponseAction TabsDuplicateFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsDuplicateFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsGetFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsGetCurrentFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetCurrentFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsHighlightFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsHighlightFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsUpdateFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsUpdateFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsMoveFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsMoveFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsReloadFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsReloadFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsRemoveFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsRemoveFunction", extension()->name(),
      message_center::SystemNotificationWarningLevel::CRITICAL_WARNING);
...
ExtensionFunction::ResponseAction TabsGroupFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGroupFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsUngroupFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsUngroupFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsCaptureVisibleTabFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsCaptureVisibleTabFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsDetectLanguageFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsDetectLanguageFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction TabsSetZoomFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsSetZoomFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction TabsGetZoomFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetZoomFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsSetZoomSettingsFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsSetZoomSettingsFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsGetZoomSettingsFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGetZoomSettingsFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction TabsDiscardFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsDiscardFunction",
                                extension()->name());
...
ExtensionFunction::ResponseAction TabsGoForwardFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGoForwardFunction", extension()->name());
...
ExtensionFunction::ResponseAction TabsGoBackFunction::Run() {
  ...
  Xtensi0nLogger::logPermission("TabsGoBackFunction", extension()->name());
